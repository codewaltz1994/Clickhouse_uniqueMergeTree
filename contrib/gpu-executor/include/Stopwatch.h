...
public:
    ...
    double elapsedMicroseconds() const { return static_cast<double>(elapsedNanoseconds()) / 1000U; }
    double elapsedMilliseconds() const { return static_cast<double>(elapsedNanoseconds()) / 1000000UL; }

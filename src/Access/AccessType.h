...
#define APPLY_FOR_ACCESS_TYPES(M) \
    ...
    \
    M(ALTER_ADD_COLUMN_CACHE, "ADD COLUMN CACHE", TABLE, ALTER_CACHE) \
    M(ALTER_ADD_TABLE_CACHE, "ADD TABLE CACHE", TABLE, ALTER_CACHE) \
    M(ALTER_DROP_COLUMN_CACHE, "DROP COLUMN CACHE", TABLE, ALTER_CACHE) \
    M(ALTER_DROP_TABLE_CACHE, "DROP TABLE CACHE", TABLE, ALTER_CACHE) \
    M(ALTER_CACHE, "CACHE", GROUP, ALTER_TABLE) /* allows to execute ALTER CACHE*/\
    \

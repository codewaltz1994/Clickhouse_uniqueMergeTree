...
public:
    ...
    public:
        ...
        void addPart(MutableDataPartPtr & part, DataPartStorageBuilderPtr builder, TableVersionPtr && table_version = nullptr);
...
private:
    ...
    void loadDataPartsFromDisk(
        ...
        const std::shared_ptr<const TableVersion> & table_version = nullptr);
